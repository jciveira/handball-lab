  ...
  return (
    <div className="flex flex-col items-center min-h-dvh bg-hbl-bg p-6 gap-6">
      ...
      <div className="flex flex-col gap-4 w-full max-w-sm">
        <span className="text-xs uppercase tracking-widest text-hbl-text-muted font-medium px-1">
          Códigos de acceso
        </span>
        <CodeRow
          label="Código de anotador"
          code={match.scorekeeper_code}
          hint="Para el operador"
        />

        <LinkRow
          label="Enlace de espectador"
          url={viewerUrl}
          hint="Compartir por WhatsApp"
        />
      </div>
